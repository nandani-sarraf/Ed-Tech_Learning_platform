    ...
    <div className="app">
      ...
      <section className="main">
        ...
        <div className="bottom-section">
          ...
          <p className="info">
            This is a chatGPT clone that is made as a side project by Nandani, Ayush and Vasundhara. This poject has its own frontend and backend, it uses the
